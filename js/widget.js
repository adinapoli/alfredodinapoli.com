            ...
            return {
                init: function (x) {
                    ...
                    if (x.version >= 2 && !TWTR.Widget.hasLoadedStyleSheet) {
                        if (x.creator) {
                            s.loadStyleSheet("widget.css", this.widgetEl)
                        } else {
                            s.loadStyleSheet(t + "widget.css", this.widgetEl)
                        }
                    }
                ...
                _getWidgetHtml: function () {
                    ...
                    var z = t + "github.com/CharlesStain/alfredodinapoli.com/raw/master/img/widget-bird.png";
                    if (this._isFullScreen) {
                        z = t + "github.com/CharlesStain/alfredodinapoli.com/raw/master/img/widget-bird.png"
                    }
